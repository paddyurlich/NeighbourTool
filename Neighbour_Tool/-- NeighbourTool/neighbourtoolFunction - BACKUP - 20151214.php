						...
						if ($debug == true) {						
							...
							for ( $y = 0; $y <= 9; $y+= 1) {																
								...
								if  ($theMMLValue == "RNC_ID" or $theMMLValue == "nRNC_ID")  {
									...
									echo "DEBUG 1.1 theMMLValue: ".$theMMLValue."<br>";
									echo "DEBUG 1.2 FLAorCELLNameToLookup: ".$FLAorCELLNameToLookup."<br>";
									echo "DEBUG 1.3 FLAorCELLNameToLookup: ".$FLAorCELLNameToLookup."<br>";
									echo "DEBUG 1.4 celltable: ".$celltable."<br>";
									...
									//temp debug
									echo "DEBUG 2: first actual MML Value: ".$actualMMLValue."<br>";

									$actualMMLValue = $result_array_RNC_Lookup[$actualMMLValue]['RNC_ID'];

									//temp debug
									echo "DEBUG 3: second actual MML Value: ".$actualMMLValue."<br>";



									//temp debug
									echo "DEBUG 4: Actual MML Value = ".$actualMMLValue." on neighbour input row ".$row."<br>";
